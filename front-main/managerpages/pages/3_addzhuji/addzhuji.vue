  ...
  <div>
    ...
    <div class="w">
      ...
      <div class="main">
            ...
            <div id="phtitle">增加主机</div>
            <div id="line"></div>
            <div class="addzhuji">
              请输入主机名：
              <el-input v-model="zhujiname"></el-input>
            </div>
            <div class="addzhuji">
              请输入ip：
            ...
            <div class="addzhuji">
              请输入默认连接的交换机：
              <el-input v-model="morenjiaohuanji"></el-input>
            </div>
            <el-button round id="addzhuji" @click="open" :disabled="ip==''||zhujiname==''||morenjiaohuanji==''">提交</el-button>
      </div>
    </div>
  </div>
</template>
