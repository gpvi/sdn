  ...
  <div>
    ...
    <div class="w">
      ...
      <div class="main">
        ...
        <div id="phtitle">删除交换机</div>
        <div id="line"></div>
        <div class="deljiaohuanji">
              请输入要删除的交换机名：
              <el-input v-model="jiaohuanjiname"></el-input>
            </div>
            <el-button round id="deljiaohuanji" @click="open" :disabled="jiaohuanjiname==''">确认</el-button>
